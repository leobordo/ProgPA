...
import { BullJobStatus, JobStatus } from "../models/jobStatus";  // Types and enums for job status management.
...
import { ResultSchema } from '../middlewares/validationSchemas/jobResultSchema';
